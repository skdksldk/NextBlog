...
const PublishForm = () => {
    ...
    const publishBlog = (e) => {
        ...
        if(!title.length){
            ...
            return toast.error("Write a description explaining your blog within 200 chracters to publish")
        } else if(!tags.length){
        ...
        <AnimationWrapper>
            <section className="lg:fixed top-0 w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="border-grey lg:border-l lg:pl-8">
                    ...
                    <input type="text" placeholder="Blog Title" defaultValue={title.length ? title : ""} 
                    ...
                    <div className="relative input-box pl-2 py-2 pb-4">
                        <input type="text" placeholder="Topic" className="sticky input-box bg-white focus:bg-white top-0 left-0 pl-4 mb-3" 
                    ...
                    onClick={publishBlog}
                    >{ !blog_id ? "Publish" : "Save Changes" }</button>
